<div class="min-h-screen bg-gray-50">
    ...
    <div class="bg-white border-b border-gray-200 px-4 sm:px-6 py-4 sticky top-0 z-40">
        ...
        <nav class="flex gap-1 mt-3 -mb-4 overflow-x-auto">
            @foreach (['details' => 'Details', 'about' => 'About', 'leadership' => 'Leadership', 'facilities' => 'Facilities', 'admission' => 'Admissions', 'gallery' => 'Gallery', 'pages' => 'Pages', 'theme' => 'Theme', 'domain' => 'Domain & Publish'] as $tab => $label)
