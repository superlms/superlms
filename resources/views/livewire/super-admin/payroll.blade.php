<div class="min-h-screen bg-gray-50">
    ...
    @php
        $typeChip = [
            ...
            'counsellor' => 'bg-blue-50 text-blue-700 border-blue-100',
                                ...
                                <tr class="hover:bg-gray-50/60 transition-colors" wire:key="emp-{{ $emp->id }}">
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center justify-center gap-1">
                                            ...
                                            <button wire:click="confirmDeleteEmployee({{ $emp->id }})" title="Delete" class="p-1.5 rounded-md text-red-600 hover:bg-red-50 transition-colors">
            ...
            @if ($attendanceMode === 'mark')
                ...
                <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                    <div class="px-4 py-3 border-b border-gray-100 bg-gradient-to-r from-emerald-50 to-teal-50 flex flex-wrap items-center justify-between gap-2">
                        ...
                        <span class="text-xs text-gray-400">Nothing is saved until you submit</span>
                    </div>
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            <thead class="bg-gray-50 border-b border-gray-200">
            ...
            <div class="absolute top-0 right-0 bottom-0 w-full max-w-xl bg-white shadow-2xl flex flex-col">
                <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 flex-shrink-0">
                    <div>
                        ...
                        <p class="text-xs text-gray-500 mt-0.5">Internal SuperLMS staff record</p>
                    </div>
        ...
        <div class="fixed inset-0 z-[70] overflow-hidden" x-data @keydown.escape.window="$wire.closeEmpDetailModal()">
            ...
            <div class="absolute top-0 right-0 bottom-0 w-full max-w-xl bg-white shadow-2xl flex flex-col">
                ...
                <div class="px-6 py-3.5 border-t border-gray-200 flex items-center justify-between flex-shrink-0">
                    <button wire:click="openEmpModal({{ $selectedEmployee->id }})"
            ...
            <div class="relative bg-white rounded-xl shadow-2xl w-full max-w-sm p-6">
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-gray-500">This will permanently delete the employee, their photo, and all attendance & salary records. This action cannot be undone.</p>
                    </div>
                </div>
                <div class="flex items-center justify-end gap-2 mt-5">
                    <button wire:click="cancelDeleteEmployee" class="px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100 rounded-md transition-colors">Cancel</button>
                    <button wire:click="executeDeleteEmployee" wire:loading.attr="disabled"
                        ...
                        <span wire:loading.remove wire:target="executeDeleteEmployee">Delete Employee</span>
                        <span wire:loading wire:target="executeDeleteEmployee">Deleting...</span>
                    </button>
                </div>
            </div>
        </div>
