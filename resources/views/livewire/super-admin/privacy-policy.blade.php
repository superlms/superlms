            ...
            <button wire:click="switchTab('edit')"
                class="py-3.5 px-5 text-sm font-semibold border-b-2 transition-colors
                       {{ $activeTab === 'edit'
                           ...
                           : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                {{ $privacyPolicy ? 'Edit' : 'Create' }} Privacy Policy
            </button>
        </nav>
    </div>
    ...
    @if ($activeTab === 'view')
        @if (!$privacyPolicy)
            <div class="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
                ...
                <h3 class="text-xl font-semibold text-gray-700 mb-2">No Privacy Policy Yet</h3>
                <p class="text-gray-400 text-sm mb-5 max-w-sm">Create your platform's privacy policy to display it here.
                </p>
                <button wire:click="switchTab('edit')"
        ...
        @else
            @php
                $metadata = $privacyPolicy->metadata ?? [];
                        ...
                        <div
                            ...
                            @if (!empty($section['head']))
                                <div
                                    ...
                                    <span
                                        class="w-8 h-8 bg-gradient-to-br from-green-500 to-emerald-600
        ...
        <div class="max-w-5xl mx-auto px-6 py-8 space-y-6">
            ...
            <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                <div
                    ...
                    <h2 class="text-base font-semibold text-gray-900">Last Updated Date</h2>
                </div>
                <div class="p-6">
                    <div class="max-w-xs">
                        <label class="block text-xs font-medium text-gray-600 mb-1">
                            Date <span class="text-gray-400 font-normal">(auto-set to today on edit)</span>
                        </label>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                <div
                    ...
                    <div class="flex items-center gap-3">
                        <div class="w-8 h-8 bg-emerald-500 rounded-xl flex items-center justify-center shadow-sm">
                        ...
                        <div>
                            <h2 class="text-base font-semibold text-gray-900">Policy Sections</h2>
                            <p class="text-xs text-gray-400">{{ count($sections) }} section(s)</p>
                        </div>
                    </div>
                    <button wire:click="addSection"
                        class="inline-flex items-center gap-1.5 px-3.5 py-2 bg-emerald-600 hover:bg-emerald-700
                ...
                <div class="p-6 space-y-4">
                    @foreach ($sections as $index => $section)
                        <div class="border border-gray-200 rounded-xl p-4 hover:border-green-200 transition-colors">
                            <div class="flex items-center justify-between mb-3">
                                <span class="flex items-center gap-2">
                                    <span
                                        class="w-6 h-6 bg-green-100 text-green-700 text-xs font-bold
                            ...
                            <div class="space-y-3">
                                ...
                                <div>
                                    ...
                                    <textarea wire:model="sections.{{ $index }}.desc" rows="4"
                                        ...
                                        class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm
                                               focus:ring-2 focus:ring-green-400 focus:border-green-400 resize-y"></textarea>
                    ...
                    <button wire:click="addSection"
                        class="w-full py-3 border-2 border-dashed border-gray-300 rounded-xl text-sm
                               text-gray-400 hover:border-green-400 hover:text-green-500 transition-colors
