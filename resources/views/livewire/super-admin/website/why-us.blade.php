    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 py-8 space-y-6">
        ...
        @include('livewire.super-admin.website.partials.repeater', [
            ...
            'fields'   => [
                ...
                ['name' => 'title', 'label' => 'Title',        'placeholder' => 'Genuinely Affordable'],
                ['name' => 'desc',  'label' => 'Description',   'type' => 'textarea', 'full' => true, 'placeholder' => 'Short description for this card...'],
            ],
        ])
    </div>
