            ...
            <button wire:click="switchTab('edit')"
                class="py-3.5 px-5 text-sm font-semibold border-b-2 transition-colors
                       {{ $activeTab === 'edit'
                           ...
                           : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                {{ $termOfUse ? 'Edit' : 'Create' }} Terms And Condition
            </button>
        </nav>
    </div>
    ...
    @if ($activeTab === 'view')
        @if (!$termOfUse)
            <div class="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
                ...
                <h3 class="text-xl font-semibold text-gray-700 mb-2">No Terms And Condition Yet</h3>
                <p class="text-gray-400 text-sm mb-5 max-w-sm">Create your platform's terms and condition to display
                    them here.</p>
                <button wire:click="switchTab('edit')"
            ...
            <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                <div
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h2 class="text-base font-semibold text-gray-900">Terms Sections</h2>
                            ...
                            <div class="space-y-3">
                                ...
                                <div>
                                    ...
                                    <textarea wire:model="sections.{{ $index }}.desc" rows="4"
                                        ...
                                        class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm
                                               focus:ring-2 focus:ring-indigo-400 focus:border-indigo-400 resize-y"></textarea>
