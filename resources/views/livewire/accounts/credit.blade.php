                ...
                <div class="flex-1 overflow-y-auto px-6 py-6 space-y-4">
                    <div>
                        ...
                        <input wire:model="creditAmount" type="number" min="1" step="1" placeholder="e.g. 50000"
                            class="w-full px-3.5 py-2.5 text-sm border border-gray-300 rounded-md focus:ring-1 focus:ring-emerald-500 focus:border-emerald-500"/>
                    ...
                    <div>
                        ...
                        <textarea wire:model="creditReason" rows="4" maxlength="2000" placeholder="Explain why you need this credit..."
                            class="w-full px-3.5 py-2.5 text-sm border border-gray-300 rounded-md resize-none focus:ring-1 focus:ring-emerald-500 focus:border-emerald-500"></textarea>
