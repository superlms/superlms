    ...
    <div class="bg-white border-b border-gray-200 sticky top-0 z-30">
        <div class="px-4 sm:px-6 py-3">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div>
                    <h1 class="text-lg sm:text-xl font-bold text-gray-900">ID Card</h1>
                </div>
                            ...
                            <tr wire:key="card-{{ $cardType }}-{{ $card->id }}" class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center justify-center gap-1">
                                        ...
                                        <a href="{{ route('accounts.id-card.print', ['organization' => auth()->user()->organization_id, 'type' => $cardType, 'id' => $card->id]) }}" target="_blank"
        ...
        <div class="fixed inset-0 z-[9999] overflow-hidden">
            ...
            <div class="absolute top-0 right-0 bottom-0 w-full max-w-2xl bg-white shadow-2xl flex flex-col" wire:click.stop>
                ...
                <div class="px-6 py-4 border-t border-gray-100 bg-white flex justify-end gap-2 flex-shrink-0">
                    <a href="{{ route('accounts.id-card.print', ['organization' => auth()->user()->organization_id, 'type' => $viewType, 'id' => $viewCard->id]) }}" target="_blank"
