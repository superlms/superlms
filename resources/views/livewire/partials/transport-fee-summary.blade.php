    ...
    <div class="space-y-5">
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center justify-center gap-1.5">
                                            <button type="button" x-data title="Print receipt"
                                                x-on:click="window.open(@js(route(request()->routeIs('accounts.*') ? 'accounts.transport.receipt' : 'admin.transport.receipt', ['organization' => auth()->user()->organization_id, 'id' => $p->id, 'print' => 1])), '_blank')"
        ...
        @else
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-12 text-center">
                ...
                <p class="text-sm text-gray-600 font-medium">Pick a route and student to view the fee summary.</p>
            </div>
        @endif
    </div>
