<div class="min-h-screen bg-gray-50">
    ...
    @if (!$policy)
        <div class="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
            ...
            <h3 class="text-xl font-semibold text-gray-700 mb-2">No Terms of Use Published</h3>
            <p class="text-gray-400 text-sm max-w-sm">The terms of use has not been set up yet. Please contact your
                administrator.</p>
        </div>
    @else
        {{-- ══════════════════════════════════════════════════
        ...
        <div class="bg-white border-b border-gray-200 px-4 sm:px-6 py-3 sm:py-4">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div class="flex items-center gap-3 min-w-0">
                    ...
                    <div class="min-w-0">
                        <h1 class="text-lg sm:text-2xl font-bold text-gray-900 truncate">Terms Of Use</h1>
