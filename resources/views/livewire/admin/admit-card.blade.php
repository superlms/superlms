    ...
    <div class="fixed inset-0 z-[9998] overflow-hidden">
        ...
        <div class="absolute top-0 right-0 bottom-0 w-full max-w-2xl bg-white shadow-2xl flex flex-col">
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-5 space-y-4">
                <div class="flex items-center justify-between">
                    ...
                    <button type="button" wire:click="addBulkSubject"
                        class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-blue-600 text-white text-xs font-semibold rounded-md hover:bg-blue-700 transition">
                    ...
                    <div class="bg-gray-50 rounded-lg p-3 border border-gray-200">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-5 gap-3">
                            <div class="col-span-2">
                                ...
                                <select wire:model="bulkSubjects.{{ $i }}.subject_id" wire:change="syncBulkSubjectName({{ $i }})"
            ...
            <div class="px-6 py-3.5 border-t border-gray-200 flex items-center justify-end gap-2 flex-shrink-0">
                ...
                <button wire:click="bulkGenerateAdmitCards" wire:loading.attr="disabled"
                    class="inline-flex items-center gap-2 px-5 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm rounded-lg font-semibold shadow-sm transition">
    ...
    <div class="bg-white border-b border-gray-200 sticky top-0 z-30">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                ...
                <div class="flex flex-wrap items-center gap-2">
                    ...
                    <button wire:click="openBulkScreen"
                        class="inline-flex items-center gap-1.5 px-3 py-2 border border-blue-200 bg-blue-50 text-blue-700 text-sm font-semibold rounded-lg hover:bg-blue-100 transition">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" /></svg>
                        Bulk Generate
                    </button>
        ...
        <div class="border-t border-gray-200 bg-gray-50 px-4 sm:px-6 py-3">
            <div class="flex flex-wrap items-center gap-3">
                ...
                <input wire:model.live.debounce.300ms="search" type="text" placeholder="Name, card no, roll no…"
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center justify-center gap-1">
                                    <a href="{{ route('admin.admit-card.view', [$org->serial_number ?? $org->id, $card->id]) }}" target="_blank"
        ...
        <div class="absolute top-0 right-0 bottom-0 w-full max-w-2xl bg-white shadow-2xl flex flex-col" wire:click.stop>
            ...
            <div class="px-6 py-4 border-t border-gray-100 flex justify-between items-center bg-gray-50 flex-shrink-0">
                ...
                <div class="flex gap-2">
                    ...
                    <button type="button" wire:click="issueAdmitCards" wire:loading.attr="disabled"
                        class="inline-flex items-center gap-2 px-4 py-2 text-sm bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-semibold shadow-sm transition">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4" /></svg>
                        Issue Cards
                    </button>
                </div>
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-6 gap-2 items-end">
                                ...
                                <div class="flex items-end gap-1 justify-end">
                                    ...
                                    <button type="button" wire:click="removeEditSubject({{ $i }})" class="p-1 text-red-400 hover:text-red-600 rounded">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m14-3h-4l-1-1h-4l-1 1H5" /></svg>
                                    </button>
                                    @endif
                                </div>
                            </div>
