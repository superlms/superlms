        ...
        <div class="px-4 sm:px-6 py-4 sm:py-5">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-0.5">Manage teacher and student queries</p>
                </div>
                <div class="hidden lg:flex items-center gap-4 text-sm text-gray-500 divide-x divide-gray-200">
                    <span class="pr-4">Teachers: <strong class="text-gray-800">{{ $totalTeacher }}</strong></span>
                    <span class="px-4">Students: <strong class="text-gray-800">{{ $totalStudent }}</strong></span>
        ...
        <div class="space-y-3">
            ...
            @empty
                <div class="text-center py-20 bg-white rounded-xl border border-gray-200">
                    ...
                    <p class="text-sm text-gray-400 mt-1">{{ $activeTab === 'teacher' ? 'Teacher' : 'Student' }} queries will appear here.</p>
                </div>
            @endforelse
        </div>
