        ...
        <div class="fixed inset-0 z-50 overflow-hidden">
            ...
            <div class="absolute top-0 right-0 bottom-0 w-full max-w-xl bg-white shadow-2xl flex flex-col">
                ...
                <form wire:submit.prevent="saveStandard" class="flex-1 overflow-y-auto px-6 py-6 space-y-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1.5">Board</label>
                        <input type="text" value="{{ $standardBoard ?: 'Not set for organization' }}" readonly
                            class="w-full px-3.5 py-2.5 border border-gray-200 rounded-md text-sm bg-gray-50 text-gray-600 cursor-not-allowed">
            ...
            <div class="absolute top-0 right-0 bottom-0 w-full max-w-xl bg-white shadow-2xl flex flex-col">
                ...
                <form wire:submit.prevent="saveSection" class="flex-1 overflow-y-auto px-6 py-6 space-y-4">
                    ...
                    <div>
                        ...
                        <textarea wire:model.defer="sectionDescription" rows="3" placeholder="Optional description"
