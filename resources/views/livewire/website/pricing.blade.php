 ...
 <section id="pricing" class="py-16 bg-white">
     <div class="max-w-6xl mx-auto px-4">
         <h2 class="text-5xl font-bold text-left mb-2">Pricing</h2>
         ...
         <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
             <p class="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-extrabold text-indigo-900">
                 Starts <span class="text-indigo-700">@83.33/month.</span>
             </p>
             <button onclick="document.getElementById('contact-us').scrollIntoView({ behavior: 'smooth' })"
                 class="w-full md:w-80 bg-gradient-to-r from-pink-500 to-purple-600 text-white py-3 rounded-xl shadow-lg hover:opacity-90 transition text-lg font-bold">
                 Get Custom Pricing
             </button>
         </div>
