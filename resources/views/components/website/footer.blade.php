    ...
    <div style="max-width:1280px;margin:0 auto;">
        <div class="footer-grid">
            ...
            <div>
                ...
                <p class="footer-brand-desc">EDYONE LMS is India's leading affordable Learning Management System for
                    schools and educational institutions. Trusted by many schools across India.</p>
                <div class="footer-socials">
                    <a class="social-btn"
                        href="https://www.instagram.com/edyonelms?utm_source=ig_web_button_share_sheet&igsh=ZzlkamE5ZTR5MDB6"
                    ...
                    <a class="social-btn" href="https://www.whatsapp.com/channel/0029Vb6myRCKGGGKSCgVFP0M"
                    ...
                    <a class="social-btn" href="https://www.youtube.com/@edyonelms" target="_blank"
            ...
            <div>
                ...
                <div style="display:flex;flex-direction:column;gap:10px;">
                    <div style="display:flex;gap:8px;align-items:flex-start;color:var(--text3);font-size:12px;">
                        <span>📧</span><span>support@edyonelms.in</span>
                    </div>
                    <div style="display:flex;gap:8px;align-items:flex-start;color:var(--text3);font-size:12px;">
