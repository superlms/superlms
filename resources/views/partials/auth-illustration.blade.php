{{--
    Dynamic auth illustration for the admin login / OTP / reset-password screens.
    Pass a $variant: 'login' | 'otp' | 'reset' | 'newpass'. Each renders a clean,
    minimal inline-SVG scene tied to that step (no static image asset). Colours
    track the brand violet/pink so the art matches the rest of the panel.
--}}
    ...
    @switch($variant)
        @case('otp')
            <svg viewBox="0 0 320 280" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-full h-auto">
                <circle cx="160" cy="142" r="112" fill="#F5F3FF"/>
                <circle cx="160" cy="150" r="84" fill="#EDE9FE"/>
                <rect x="96" y="96" width="128" height="90" rx="16" fill="#FFFFFF" stroke="#E9D5FF" stroke-width="2"/>
                <path d="M104 106 L160 144 L216 106" fill="none" stroke="#C4B5FD" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                <rect x="112" y="150" width="96" height="36" rx="11" fill="#7C3AED"/>
                ...
                <circle cx="214" cy="104" r="18" fill="#EC4899"/>
                ...
                <circle cx="84" cy="178" r="5" fill="#C4B5FD"/>
                <circle cx="238" cy="156" r="4" fill="#F9A8D4"/>
            </svg>
            @break
        ...
        @case('reset')
            <svg viewBox="0 0 320 280" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-full h-auto">
                <circle cx="160" cy="142" r="112" fill="#F5F3FF"/>
                <circle cx="160" cy="150" r="84" fill="#EDE9FE"/>
                <path d="M138 132 v-14 a22 22 0 0 1 44 0 v14" fill="none" stroke="#7C3AED" stroke-width="11" stroke-linecap="round"/>
                <rect x="122" y="130" width="76" height="66" rx="16" fill="#7C3AED"/>
                <circle cx="160" cy="156" r="8" fill="#FFFFFF"/>
                <rect x="156" y="160" width="8" height="16" rx="4" fill="#FFFFFF"/>
                <circle cx="210" cy="96" r="18" fill="#EC4899"/>
                ...
                <circle cx="86" cy="180" r="5" fill="#C4B5FD"/>
                <circle cx="236" cy="166" r="4" fill="#F9A8D4"/>
            </svg>
            @break
        ...
        @default
            ...
            <svg viewBox="0 0 320 280" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-full h-auto">
                <circle cx="160" cy="142" r="112" fill="#F5F3FF"/>
                <circle cx="160" cy="150" r="84" fill="#EDE9FE"/>
                <rect x="96" y="68" width="128" height="152" rx="20" fill="#FFFFFF" stroke="#E9D5FF" stroke-width="2"/>
                <circle cx="160" cy="104" r="22" fill="#F5F3FF"/>
                <circle cx="160" cy="99" r="7.5" fill="#7C3AED"/>
                <path d="M147 117 a13 13 0 0 1 26 0 Z" fill="#7C3AED"/>
                <rect x="116" y="142" width="88" height="13" rx="6.5" fill="#F1F5F9"/>
                <rect x="116" y="165" width="88" height="13" rx="6.5" fill="#F1F5F9"/>
                <rect x="116" y="192" width="88" height="17" rx="8.5" fill="#7C3AED"/>
                <circle cx="214" cy="82" r="18" fill="#EC4899"/>
                <path d="M207 82 l4.5 4.5 L222 75" fill="none" stroke="#FFFFFF" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                <circle cx="84" cy="176" r="5" fill="#C4B5FD"/>
                <circle cx="236" cy="166" r="4" fill="#F9A8D4"/>
            </svg>
    @endswitch
