...
<head>
    ...
    <style>
        /* ─── DomPDF print styles — modelled after the Shreeji Public School
               report-card template the school provided. A4 portrait, single
               thin sky-blue border around the whole sheet, serif title with
               an underline, dense bordered tables. ─────────────────────── */
        * { margin: 0; padding: 0; box-sizing: border-box; }
        @page { size: A4 portrait; margin: 14px; }
        body { font-family: DejaVu Sans, Arial, sans-serif; font-size: 10px; color: #1f2937; }

        .sheet { border: 1px solid #93c5fd; padding: 14px 18px; }
        ...
        .brand .doc-title { font-size: 12px; font-weight: bold; color: #111827; margin-top: 10px; }
        ...
        table.marks .bigtotal { font-size: 13px; font-weight: bold; vertical-align: middle; }
