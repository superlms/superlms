...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; }
        ...
        {{-- Mobile / email / website belong with the address, not stranded at the foot of
             the page — the masthead is where a reader looks for the school. --}}
        .school-contact { font-size: 9pt; color: #9ca3af; margin-top: 2.5mm; }

        .cert-title { font-size: 36pt; font-weight: bold; color: #1f2937; font-family: "DejaVu Serif", Georgia, serif; letter-spacing: 5px; text-transform: uppercase; margin-top: 11mm; }
        ...
        {{-- What it was awarded for comes straight after the name; the prose explaining
             it follows. --}}
        .event-name { font-size: 11pt; color: #a8862f; letter-spacing: 3px; text-transform: uppercase; margin-top: 12mm; }
        .description { font-size: 11pt; color: #4b5563; line-height: 1.8; width: 150mm; margin: 13mm auto 0; }

        {{-- The seal stands on its own, low on the page, just above the signing line. --}}
        .seal { position: absolute; left: 0; right: 0; bottom: 31mm; }
        ...
        {{-- Signing line, on the last band of the page. --}}
        .footer { position: absolute; left: 24mm; right: 24mm; bottom: 15mm; }
...
<div class="page">
    ...
    <div class="content">
        @php
            ...
            // The controller supplies the masthead; fall back to the school record alone
            // so the template still renders when handed nothing but a certificate.
            $contact = $contact ?? [];
            $address = $contact['address'] ?? ($cert->organization->address ?? null);
