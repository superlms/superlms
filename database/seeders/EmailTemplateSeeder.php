    ...
    public function run(): void
    {
        EmailTemplate::updateOrCreate(
            ...
            [
                ...
                'subject' => '{{panelName}} - OTP Verification',
                'body' => $this->otpVerificationBody(),
                'is_active' => true,
            ]
        );
    }

    private function otpVerificationBody(): string
    {
        return <<<'HTML'
<!DOCTYPE html>
<html>
...
<body>
    <div class="container">
        <div class="title">{{panelName}} - OTP Verification</div>
